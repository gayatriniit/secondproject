<html ng-app="Funchat" ng-init="likes=0;viewBlogs=false;blog=false;userForum=false;users=false;adminJobs=false;adminBlog=false;jobs=false;login=true;register=true;about=true;services=true;home=true;logout=false;chat=false;uname='data'">
<head>
  ...
  <script src="js/gayatri1.js"></script>
  <style>
body { 
